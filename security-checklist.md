...
- [ ] For user ids and other ids, use  `UUID` instead of integers. You can find an implementation for this for your language on Github.
...
- [ ] In Android, all the granted should be carefully evaluated.
...
- [ ] Have your code review done by a fellow developer from a secure coding perspective. 
